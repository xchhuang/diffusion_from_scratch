...
accelerate launch --mixed_precision fp16 main_v.py --batch_size=8 --epochs=2 --learning_rate=0.0001 --train_or_test=train --neuralnet_name=unet_small
accelerate launch --mixed_precision fp16 main_v.py --batch_size=8 --epochs=2 --learning_rate=0.0001 --train_or_test=test --neuralnet_name=unet_small
